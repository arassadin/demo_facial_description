...
echo "[$(date +"%T")] [INFO] Downloading Rother et al. age model.."
wget -nv https://data.vision.ee.ethz.ch/cvl/rrothe/imdb-wiki/static/dex_chalearn_iccv2015.caffemodel -O models/Rother\ et\ al./age_weights.caffemodel
[[ $? > 0 ]] && { echo "[ERROR] Unable to download model"; exit 1; }

echo "[$(date +"%T")] [INFO] Downloading Rother et al. gender model.."
wget -nv https://data.vision.ee.ethz.ch/cvl/rrothe/imdb-wiki/static/gender.caffemodel -O models/Rother\ et\ al./gender_weights.caffemodel
[[ $? > 0 ]] && { echo "[ERROR] Unable to download model"; exit 1; }
